...
public class AuroraSwitch extends SettingsPreferenceFragment {

    private static final String TAG = "AuroraSwitch";
    private static final String AURORA_ENABLED = "aurora_enabled";
    private static final String AURORA_ENABLED_FOOTER = "aurora_enabled_footer";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.aurora_enabled_settings);

        mResolver = getContext().getContentResolver();

        mEnabled = Settings.Secure.getIntForUser(mResolver,
            Settings.Secure.AURORA_ENABLED, 0, UserHandle.USER_CURRENT) != 0;

        mSwitchEnable = (SwitchPreference) findPreference(AURORA_ENABLED);
        if( mSwitchEnable != null ) {
            mSwitchEnable.setChecked(mEnabled);
            Log.e(TAG, "mSwitchEnable: aurora_enabled=" + mEnabled);
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    try {
                        ...
                        Settings.Secure.putIntForUser(mResolver,
                               Settings.Secure.AURORA_ENABLED, (Boolean) newValue ? 1:0, UserHandle.USER_CURRENT);
