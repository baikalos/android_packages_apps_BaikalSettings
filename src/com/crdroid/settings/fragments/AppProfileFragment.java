...
public class AppProfileFragment extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAppSettings = BaikalAppProfileBackend.getInstance(mContext, 1000, "com.android.settings", -1, "com.android.settings");
    ...
    private boolean isStaminaImportant() {
        try {
            if( SystemProperties.get("sys.baikal.dialer","").equals(mPackageName) ) return true; 
            if( SystemProperties.get("sys.baikal.sms","").equals(mPackageName) ) return true; 
            if( SystemProperties.get("sys.baikal.call_screening","").equals(mPackageName) ) return true; 
        } catch( Exception e ) {
        }
        return false;
    }
