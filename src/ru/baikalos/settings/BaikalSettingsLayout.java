...
public class BaikalSettingsLayout extends SettingsPreferenceFragment {
    ...
    //private BaikalAppProfileBackend mAppProfileSettings;
    ...
    public void onCreate(Bundle savedInstanceState) {
	    ...
	    addPreferencesFromResource(R.xml.baikalos_dashboard);

        mContext = (Context) getActivity();
        final Resources res = getActivity().getResources();

        final PreferenceScreen screen = getPreferenceScreen();
        //mAppProfileSettings = BaikalAppProfileBackend.getInstance(new Handler(),mContext);
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.baikalos_dashboard) {
