...
public class BaikalFlags { 
    ...
    public void init() {
        ...
        add(new BaikalFlag("app_profile_bypass_charging","app_profile_bypass_charging","",false,false,true));
        ...
        add(new BaikalFlag("app_profile_heavy_memory","app_profile_heavy_memory","",false,true,false));
        ...
        add(new BaikalFlag("app_profile_darkmode","app_profile_darkmode","",false,true,false));
        add(new BaikalFlag("app_profile_max_fps","app_profile_max_fps","",false,true,false));
        add(new BaikalFlag("app_profile_min_fps","app_profile_min_fps","",false,true,false));
