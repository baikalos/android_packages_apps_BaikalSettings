...
public class BaikalFlags { 
    ...
    public void init() {
        ...
        add(new BaikalFlag("app_profile_vpn","app_profile_vpn","",true,true,false));
        add(new BaikalFlag("app_profile_phka","app_profile_phka","",true,true,false));
        ...
        add(new BaikalFlag("app_profile_hide_phone_opt","app_profile_hide_phone_opt","",true,true,false));
        add(new BaikalFlag("app_profile_hide_sms_opt","app_profile_hide_sms_opt","",true,true,false));
        ...
        add(new BaikalFlag("app_profile_fake_su","app_profile_fake_su","",true,true,false));
        add(new BaikalFlag("app_profile_hiddenapi_su","app_profile_hiddenapi_su","",true,true,false));
        add(new BaikalFlag("app_profile_allpermissions_su","app_profile_allpermissions_su","",true,true,false));
