...
public class PowerSave extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if( !BaikalConstants.isKernelCompatible() ) {
            ...
            isKernelIncompatible = false;
        }

	    addPreferencesFromResource(R.xml.baikalos_settings_powersave);
        ...
        try {
            ...
            if( mAppPerfProfile != null ) { 
                if(!perfProf) {
                    ...
                    mAppPerfProfile.setEntries(Util.getPerfModeEntries(mContext));
                    mAppPerfProfile.setEntryValues(Util.getPerfModeValues(mContext));

                    int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_DEFAULT_PERFORMANCE, -99);
            ...
            if( mAppThermProfile != null ) {
                if(!thermProf) {
                    ...
                    int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_DEFAULT_THERMAL, -99);
                    if( profile == -99 ) profile = 0;
            ...
            if( mAppScreenOffPerfProfile != null ) { 
                ...
                if(!perfProf) {
                    ...
                    mAppScreenOffPerfProfile.setEntries(Util.getPerfModeEntries(mContext));
                    mAppScreenOffPerfProfile.setEntryValues(Util.getPerfModeValues(mContext));

                    int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_DEFAULT_SCREENOFF_PERFORMANCE, -99);
                    if( profile == -99 ) profile = 0;
            ...
            if( mAppScreenOffThermProfile != null ) {
                if(!thermProf) {
                    ...
                    int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_DEFAULT_SCREENOFF_THERMAL, -99);
                    if( profile == -99 ) profile = 0;
            ...
            if( mAppIdlePerfProfile != null ) { 
                if(!perfProf) {
                    ...
                    mAppIdlePerfProfile.setEntries(Util.getPerfModeEntries(mContext));
                    mAppIdlePerfProfile.setEntryValues(Util.getPerfModeValues(mContext));

                    int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_DEFAULT_IDLE_PERFORMANCE, -99);
                    if( profile == -99 ) profile = 0;
            ...
            if( mAppIdleThermProfile != null ) {
                if(!thermProf) {
                    ...
                    int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_DEFAULT_IDLE_THERMAL, -99);
                    if( profile == -99 ) profile = 0;
            ...
            if( mPowersaverScreenon != null ) { 
                int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_POWER_LEVEL_ON, -99);
                if( profile == -99 ) profile = 0;
            ...
            if( mPowersaverScreenonCharger != null ) { 
                int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_POWER_LEVEL_ON_CHARGER, -99);
                if( profile == -99 ) profile = 0;
            ...
            if( mPowersaverStandby != null ) { 
                int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_POWER_LEVEL_STANDBY, -99);
                if( profile == -99 ) profile = 0;
            ...
            if( mPowersaverIdle != null ) { 
                int profile = Settings.Global.getInt(resolver,Settings.Global.BAIKALOS_POWER_LEVEL_IDLE, -99);
                if( profile == -99 ) profile = 0;
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.baikalos_settings_powersave) {
