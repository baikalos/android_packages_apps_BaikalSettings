...
import ru.baikalos.settings.preferences.BluetoothDeviceGlobalPreference;
...
public class SpecialDevices extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
	    ...
	    addPreferencesFromResource(R.xml.baikalos_settings_special_devices);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.baikalos_settings_special_devices) {
