...
public class PowerSaverProfileEditor extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.baikalos_ps_profile);
        ...
        SwitchPreferenceCompat switchPreference = null;
        ListPreference listPreference = null;

        try {

            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_AdvertiseIsEnabled");
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableFullBackup");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableKeyValueBackup");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableAnimation");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableAod");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableLaunchBoost");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableInteractionBoost");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableRenderingBoost");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableOptionalSensors");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableVibration");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableAdjustBrightness");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableDataSaver");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableFirewall");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableNightMode");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_EnableQuickDoze");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_ForceAllAppsStandby");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_ForceBackgroundCheck");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_KillInBackground");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_lessRestrictiveBackgroundPolicy");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_disableBackgroundByDefault");
            if( switchPreference != null ) {
            ...
            switchPreference = (SwitchPreferenceCompat) findPreference("ps_profile_SystemPriority");
            if( switchPreference != null ) {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.baikalos_ps_profile);
}
