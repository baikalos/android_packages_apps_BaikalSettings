...
import ru.baikalos.settings.preferences.BluetoothDeviceSecurePreference;
...
public class SmartTrust extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
	    ...
	    addPreferencesFromResource(R.xml.baikalos_settings_smart_trust);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.baikalos_settings_smart_trust) {
