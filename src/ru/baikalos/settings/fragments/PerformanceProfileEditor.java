...
import ru.baikalos.settings.preferences.SystemPropertiesListPreference;
...
public class PerformanceProfileEditor extends SettingsPreferenceFragment {
    ...
    public static final String TAG = "BaikalPerfEditor";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.baikalos_profile_edit);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if( mChanged ) {
            ...
            SystemProperties.set("ctl.restart","vendor.power-hal-aidl");
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.baikalos_profile_edit);
}
