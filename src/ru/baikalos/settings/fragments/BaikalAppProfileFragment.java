...
//    private static final String APP_PROFILE_DISABLE_TWL = "app_profile_disable_twl";
    ...
    */
    ...
    private SwitchPreference mAppSpoofDefaultSMS;
    ...
    /*public BaikalAppProfileFragment(String packageName, int uid) {
        mPackageName = packageName; 
        mUid = uid;
    }*/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        if( mProfile == null ) {
            mProfile = new BaikalAppProfile(mPackageName,mUid);
        }
        ...
        try {
            ...
            */
            ...
            initListPreference(true, true, "app_profile_performance", () -> Integer.toString(mProfile.mPerfProfile), v -> mProfile.mPerfProfile = Integer.parseInt(v));
            initListPreference(true, true, "app_profile_thermal", () -> Integer.toString(mProfile.mThermalProfile), v -> mProfile.mThermalProfile = Integer.parseInt(v));
            initListPreference(true, true, "app_profile_cpu_performance_limit", () -> Integer.toString(mProfile.mPerformanceLevel), v -> mProfile.mPerformanceLevel = Integer.parseInt(v));
            initListPreference(true, true, "app_profile_boost_control", () -> Integer.toString(mProfile.mBoostControl), v -> mProfile.mBoostControl = Integer.parseInt(v));

            initSwitchPreference(false, false, "app_profile_bypass_charging", BaikalAppProfile.BAIKAL_APP_BYPASS_CHARGING, () -> mProfile.mAppOpts, v -> mProfile.mAppOpts = v);
            initSwitchPreference(false, false, "app_profile_spoof_default_dialer", BaikalAppProfile.BAIKAL_APP_DEFAULT_DIALER, () -> mProfile.mAppOpts, v -> mProfile.mAppOpts = v);
            initSwitchPreference(false, false, "app_profile_spoof_default_sms", BaikalAppProfile.BAIKAL_APP_DEFAULT_SMS, () -> mProfile.mAppOpts, v -> mProfile.mAppOpts = v);
            ...
            initSwitchPreference(true, true, "app_profile_heavy_cpu", BaikalAppProfile.BAIKAL_BACKGROUND_HEAVY_CPU, () -> mProfile.mBackgroundMode, v -> mProfile.mBackgroundMode = v);
    ...
    protected void onUnbindPreferences() {
        ...
        if( mProfile != null ) {
            Log.d(TAG, "mProfile=" + mProfile.serialize());
            if( mChanged ) {
                Log.d(TAG, "Saving profile " + mProfile.mPackageName + "/" + mProfile.mUid);
                try {
